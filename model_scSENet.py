...
class BottleNeck(chainer.Chain):
    def __init__(self, n_in, n_mid, n_out,A, use_conv=False):
        ...
        with self.init_scope():
            self.res1 = GraphConvolution(in_channels=n_in, out_channels=n_mid, A=A, K=25)
            self.bn1 = L.BatchNormalization(n_mid)
            self.res2 = GraphConvolution(in_channels=n_mid, out_channels=n_mid, A=A, K=1)
            self.bn2 = L.BatchNormalization(n_mid)
            self.res3 = GraphConvolution(in_channels=n_mid, out_channels=n_out, A=A, K=25)
...
class GraphCNN(chainer.Chain):
    def __init__(self, A, in_channels=5, out_channels=4,**kwargs):
        ...
        with self.init_scope():
            ...
            self.fc1 = L.Linear(None, out_channels, initialW=initializer)
            self.bnfc1=L.BatchNormalization(out_channels)
    ...
    def forward(self, x):
        ...
        o0_1 = F.relu(self.bn1(self.gc1(x)))
        # print("o1_1:",o1_1.shape)
        # del e0
        o0 = self.p1(o0_1)
        o1_1 = F.relu(self.r1_1(self.se1_1(o0),o0))
        o1_2=F.relu(self.r1_2(self.se1_2(o1_1),o1_1))
        o1_3=F.relu(self.r1_3(self.se1_3(o1_2),o1_2))
        o1 = self.p2(o1_3)

        o2_1=F.relu(self.r2_1(self.se2_1(o1),o1))
        o2_2=F.relu(self.r2_2(self.se2_2(o2_1),o2_1))
        o2_3=F.relu(self.r2_3(self.se2_3(o2_2),o2_2))
        o2_4=F.relu(self.r2_4(self.se2_4(o2_3),o2_3))
        o2 = self.p3(o2_4)

        # o3_1=F.relu(self.r3_1(self.se3_1(o2),o2))
        # o3_2=F.relu(self.r3_2(self.se3_2(o3_1),o3_1))
        # o3_3=F.relu(self.r3_3(self.se3_3(o3_2),o3_2))
        # o3_4=F.relu(self.r3_4(self.se3_4(o3_3),o3_3))
        # o3_5=F.relu(self.r3_5(self.se3_5(o3_4),o3_4))
        # o3_6=F.relu(self.r3_6(self.se3_6(o3_5),o3_5))
        # o3 = self.p4(o3_6)
        #
        # o4_1 = F.relu(self.r4_1(self.se4_1(o3),o3))
        # o4_2=F.relu(self.r4_2(self.se4_2(o4_1),o4_1))
        # o4_3=F.relu(self.r4_3(self.se4_3(o4_2),o4_2))

        o5=F.softmax(self.bnfc1(self.fc1(o2)),axis=1)
